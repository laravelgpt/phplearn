...
interface IconProps extends React.SVGProps<SVGSVGElement> {
  icon: 'play' | 'terminal' | 'webview' | 'spinner' | 'folder' | 'file' | 'plus' | 'chevron-right' | 'chevron-down' | 'book-open' | 'sun' | 'moon' | 'x' | 'file-plus' | 'folder-plus' | 'edit' | 'trash-2' | 'alert-triangle' | 'file-text' | 'maximize' | 'minimize' | 'menu' | 'upload' | 'download' | 'message-square' | 'shield-alert' | 'help-circle' | 'paperclip' | 'check-circle' | 'x-circle' | 'sparkles';
}
...
export const Icon: React.FC<IconProps> = ({ icon, ...props }) => {
  switch (icon) {
    ...
    case 'sparkles':
        return (
            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}>
                <path d="m12 3-1.9 3.8-3.8 1.9 3.8 1.9L12 14.4l1.9-3.8 3.8-1.9-3.8-1.9L12 3Z"/><path d="M5 21v-4"/><path d="M19 21v-4"/><path d="M3 15h4"/><path d="M17 15h4"/></svg>
        );
  }
};